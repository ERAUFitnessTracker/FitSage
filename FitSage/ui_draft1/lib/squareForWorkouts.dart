...
//                 uWorkouts.workoutsUpper[selectedIndex].isSelected = true;
...
//                 ]);
//               } else {
//                 uWorkouts.workoutsUpper[selectedIndex].isSelected = false;
//                 uWorkouts.selectedWorkouts
//                     .remove(uWorkouts.workoutsUpper[selectedIndex]);
//               }
//               for (int i = 0; i < uWorkouts.workoutsUpper.length; i++) {
//                 if (uWorkouts.workoutsUpper[i].isSelected) {
//                   uWorkouts.workoutsUpper[selectedIndex];
//                 }
//                 uWorkouts.selectedWorkouts.addAll(iterable);
//               }
//             });
//           },
//         ),
